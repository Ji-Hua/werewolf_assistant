...
class Config(object):
    ...
    MONGODB_PASSWORD = os.environ.get('MONGO_DATABASE_PASSWORD')
    MONGODB_HOST = os.environ.get('MONGO_DATABASE_URL') or \
        f"mongodb+srv://werewolf-god:{MONGODB_PASSWORD}@cluster0.1qpql.mongodb.net/production?retryWrites=true&w=majority"
...
class TestingConfig(Config):
    ...
    MONGODB_PASSWORD = os.environ.get('MONGO_DATABASE_PASSWORD')
    MONGODB_HOST = os.environ.get('MONGO_DATABASE_URL') or \
        f"mongodb+srv://werewolf-god:{MONGODB_PASSWORD}@cluster0.1qpql.mongodb.net/test?retryWrites=true&w=majority"
